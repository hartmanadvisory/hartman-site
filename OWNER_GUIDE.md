...
(Privacy, Terms, Disclosures) and the events in the homepage carousel.
Everything else — the headlines, the "what we do" services, colors, and
layout — is part of the code, and needs the AI or a developer
(Section 3).
